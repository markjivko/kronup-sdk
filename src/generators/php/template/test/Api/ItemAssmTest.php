...
class ItemAssmTest extends TestCase {
    ...
    public function testCreateRead(): void {
        ...
        $this->assertInstanceOf(Model\AssumptionList::class, $assmList);
    ...
    public function testUpdateDelete(): void {
        ...
        $assmUpdatedExp = $this->sdk
            ...
            ->assumptionExperimentUpdate(
                ...
                $assm->getId(),
                $this->orgId,
                (new Model\RequestAssmExpUpdate())
                    ->setDigest("Experiment digest")
                    ->setDetails("Experiment details")
                    ->setConfirmed(true)
                    ->setState(Model\RequestAssmExpUpdate::STATE_D)
            );
        ...
        $this->assertEquals(Model\RequestAssmExpUpdate::STATE_D, $assmUpdatedExp->getExperiment()->getState());
